...
cache.set(
  "27b2be78-a75f-4032-920c-eeb4ce00f58a",
  new User("John Doe", "john.doe@example.com")
);

cache.set(
  "7ba860e0-5de0-4801-8ff7-956cd5c556e3",
  new User("Tara Chambers", "tara.chambers@example.com")
);

cache.set(
  "b6630ac3-0e20-49e2-87c5-9277f096dc7f",
  new User("Tracey Curtis", "tracey.curtis@example.com")
);
